...
const CourseById = () => {
  ...
  const onSubmit = () => {
    if (data) {
      const body = { body: { courseId: data?.payload.course.id } };
      addFav(body)
        .unwrap()
        .then(() => {
          ...
          {error?.status == 404 || error?.status == 400 ? (
            <>
              ...
              <p>
                ...
                {/* @ts-ignore */}
                {error?.status == 404 ? (
                  <p className=" h-[50vh] flex items-center justify-center capitalize text-[18px] font-bold text-primary text-center">
                    {/* eslint-disable-next-line @typescript-eslint/ban-ts-comment */}
                    {/* @ts-ignore */}
                    {error?.data?.message}
                  </p>
                ) : (
                  <p className=" h-[50vh] flex items-center justify-center capitalize text-[28px] font-bold text-primary text-center">
                    Invalid id
                  </p>
                )}
              </p>
                  ...
                  <div className="flex flex-col-reverse lg:flex-row lg:justify-between relative">
                    <div className=" lg:basis-[70%]">
                      ...
                      <p className=" hidden lg:flex items-center gap-1">
                        <p>
                          <span>
                            {data?.payload.course.numOfEnrolledStudents}
                          </span>{" "}
                          students
                        </p>
                          ...
                          <div className=" flex justify-between items-center">
                            {loadingAddCart ? (
                              ...
                              <>
                                ...
                                <button
                                  ...
                                  className="py-2 h-[40px] bg-primary text-white font-medium w-[85%]"
                                >
                                  Add to cart
                                </button>
                              </>
                            ...
                            {loadingAddFav ? (
                              ...
                              <>
                                ...
                                <span
                                  onClick={() => onSubmit()}
                                  className=" cursor-pointer text-primary text-[24px] w-[14%] border-2 border-[#0000001b] h-[40px] flex items-center justify-center"
                                >
                                  <GrFavorite />
                                </span>
                              </>
                        ...
                        <div>
                          ...
                          <ul>
                            <li className=" flex items-center gap-2 text-[15px]">
                              ...
                              {data?.payload.course.totalLength
                                ? (
                                    data?.payload.course.totalLength / 3600
                                  ).toFixed(2)
                                : 0}{" "}
