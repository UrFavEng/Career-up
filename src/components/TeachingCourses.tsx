  ...
  return (
    <div className="flex  border-2">
      ...
      <div className=" div-EditCourse w-full capitalize pl-6 py-4 flex flex-col justify-between relative">
        <div className=" cursor-pointer text-primary bg-[#e0e0e06b] absolute top-0 left-0 w-[100%] h-[100%]  justify-center items-center font-extrabold text-[20px] sm:text-[28px]">
          Edit / manage course
        </div>
